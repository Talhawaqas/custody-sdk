...
8. **No repository governance scaffolding yet** (`CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, issue/PR templates, a top-level `README.md`) — Module 4 of the Phase 2 roadmap, not started. `SDK_GUIDE.md` (this file) is currently the only docs entry point.
